    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          ...
          develop impactful solutions that can help people.
        </Paragraph>
        <Paragraph className=" mt-4">
          I&apos;m a software developer graduating from the University of Virginia. I&apos;m currently
          a Teaching Assistant for Computer Systems and Organizations 1 (Covering Computer Architecture and low-level coding in x86-64 ISA and C) and{" "}
          Software Development Essentials (Covering the design, testing, and development of full-stack applications using Java and MySQL).
        </Paragraph>
      </div>
    </div>
  );
